...
<html lang="en">
<head>
	<title>MetalMusicCoin Donation Button</title>
	<meta http-equiv="X-UA-Compatible" content="IE=edge" />
	<meta name="description" content="MetalMusicCoin Widget  for your websites." />
	<meta name="keywords" content="MetalMusicCoin donation button,MTLMC donate" />
	<link rel="stylesheet" type="text/css" href="mtlmcDonate.css" />
	<script src="http://ajax.googleapis.com/ajax/libs/jquery/1.10.1/jquery.min.js"></script>
	<script src="http://ajax.googleapis.com/ajax/libs/jqueryui/1.10.3/jquery-ui.min.js"></script>
	<script src="mtlmcDonate.js"></script>
...
<header id="header">
	<section>
		<a href="/"><img width="304" height="78" src="images/mtlmc_logo.png" /></a>
		<div id="social1">
		<!--
...
<section>
	...
	<article class="primary">
		<h1>Add a MetalMusicCoin donation button to your website and start getting coins today!</h1>
		...
		<span id="preview_holder"><span id="preview">
			<script src="http://mtlmcdonation.metalmusiccoin.pw/widget/coin.js"></script>
			<script>MTLMCDonateCom.go({
				wallet_address 	: 'MkB6Pa3tCFE6TX9Mt8e4bCKvN7aQbAD4JY'
				, currency		: 'MetalMusicCoin'
				, counter 		: 'count'
				, alignment 	: 'ac'
				, lbl_button 	: 'Donate MetalMusicCoin'
				, lbl_address	: 'MTLMCDonation.com MetalMusicCoin Address:'
				, lbl_count 	: 'donations'
				, lbl_amount	: 'MTLMC'
				, qrcode 		: true
				, decimals 		: 6
	...
	<article id="get_it">
		...
		<div style="margin-left:90px;">
			<h1>Get a MetalMusicCoin widget right now:</h1>
			<p>Use the wizard to quickly create a widget button that you can embed in your site.</p>
			<br/>
		</div>
		
		<div id="go_buttons">
			<button onclick="wizard.start();" style="box-shadow:inset 1px 1px 0px #76b5f2;padding:8px;"><img src="images/favicon.png" />Create a MetalMusicCoin Widget now!</button> 
		</div>
	</article>
	...
	<article>
		...
		<tbody>
			<tr>
				<td><b>currency</b></td>
				<td>MetalMusicCoin</td>
				<td>MetalMusicCoin</td>
				<td class="col_desc">This widget is for MetalMusicCoin</td>
			</tr>
			...
			<tr>
				...
				<td>My MetalMusicCoin Address:</td>
				<td><em>(anything)</em></td>
				<td class="col_desc">The text that appears above your MetalMusicCoin wallet address within the window.</td>
			</tr>
			<tr>
				<td><b>lbl_count</b></td>
				<td>donations</td>
			...
			<tr>
				...
				<td>MTLMC</td>
				<td><em>(anything)</em></td>
				<td class="col_desc">The text that appears in the window under the total amount of MetalMusicCoin received.</td>
			</tr>
			<tr>
				<td><b>onShow</b></td>
				<td>null</td>
...
<pre>
&lt;script src="//mtlmcdonation.metalmusiccoin.pw/widget/coin.js"&gt;&lt;/script&gt;
&lt;script&gt;
	MTLMCDonateCom.go({
		wallet_address	: 'MkB6Pa3tCFE6TX9Mt8e4bCKvN7aQbAD4JY',
		currency 		: 'MetalMusicCoin',
		...
		lbl_count		: 'payments',
		lbl_amount 		: 'coins',
		lbl_address		: 'Please send MetalMusicCoin tips to:',
		qrcode			: false,
		decimals		: 6,
		onShow 			: function(){
			alert('window opened!');
...
&lt;/script&gt;
	...
	<article>
		...
		<div style="margin-left:90px;">
			<p><strong>Donate to MTLMCDonate</strong></p>
			<p>If you would like to help support the MTLMCDonation cause, here you go:</p>

			<div style="position:relative;top:5px;"><script>MTLMCDonateCom.go({
				wallet_address 	: 'MkB6Pa3tCFE6TX9Mt8e4bCKvN7aQbAD4JY'
				, currency		: 'MetalMusicCoin'
				, counter 		: 'hide'
				, alignment 	: 'bc'
			...
			&nbsp; <i style="font-size:10px;">Thank you very much for your generosity! -mtlmcdonation.metalmusiccoin.pw</i>
			</div>
		</div>
		<br/>
	</article>
	...
	<!-- 
			...
			<p><a href="mailto:#">E-mail me</a>, I would love to hear your ideas! I'll do my best to reply as soon as possible.</p>
	-->	
		</div>
		<br/>
	</article>

	<small id="footer">&copy; 2014 mtlmcdonation.metalmusiccoin.pw</small>
...
<div id="wizard">
	...
	<article>
		<aside>
			...
			<ul>
				<li data-page="currency" class="sel">Wallet:<b>MetalMusicCoin</b></li>
		...
		<section class="preview">
			<div>
				...
				MTLMCDonateCom.go({
					...
					, alignment 	: 'bl'
					, lbl_button 	: 'Donate'
					, lbl_address	: 'MTLMCDonate MetalMusicCoin Address:'
					, lbl_count 	: 'donations'
					, lbl_amount	: 'MTLMC'
					, qrcode 		: true
				});
		...
		<section class="step">
			<div data-page="currency">
				...
				<button data-sidebar="MetalMusicCoin" data-currency="mtlmc"><img src="images/icon_16_MetalMusicCoin.png" />MetalMusicCoin</button>
				<br/>
